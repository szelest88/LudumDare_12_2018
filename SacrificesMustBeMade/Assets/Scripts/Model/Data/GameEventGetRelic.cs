...
namespace Model
{
    public class GameEventGetRelic
    {
        ...
        {
            Name = "Get Relic",
            Predicate = gs => gs.Res.Wealth >= 125 || gs.Res.Cultists >= 125,
            Priority = 10,
            MinTurn = 10,
            Retention = 8,
            Description = "News of ancient temple spreads among University scholars. Description resembles temple depicted in 'The Book of Distant Shores'. Book says of dagger forged under red moon. Shall we send most devoted brothers on expedition. On the other hand University archaeologist are eager to go. We could aid them through dangers of dwelling within temples erected in names of The Elder Ones and steal most sought possesion right from their noses.",
            Actions = new[] {
                new GameEventAction {
                    Type = GameEventActionType.Enthusiasm,
                    Description = "Many brothers commited their flesh to couse. Scourge inflicted upon them by protective seals placed within temple meant nothing as long as it brings us closer to Your forthcoming Dark One",
                    Effect = gs => {
                        gs.Res.Cultists -= 70;
                        gs.Res.Zeal += 40;
                        return gs;
